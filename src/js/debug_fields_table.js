 ...
 * Firmware refs:
 *   API 1.49.0  d5e589f192 2026-08-20  (481 annotated fields)
 */
...
export const FIRMWARE_DEBUG_FIELDS = Object.freeze({
    "1.49.0": Object.freeze({
        ...
        ATTITUDE: Object.freeze({
            ...
            3: Object.freeze({ label: "Course Over Ground Error", unit: "rad", scale: 0.01 }),
            4: Object.freeze({ label: "GPS Heading Unusable", unit: null, scale: 1 }),
            5: Object.freeze({ label: "Rescue Phase", unit: null, scale: 1 }),
        ...
        AUTOPILOT_ALTITUDE: Object.freeze({
            ...
            4: Object.freeze({ label: "Altitude P Term", unit: null, scale: 1 }),
            5: Object.freeze({ label: "Altitude I Term", unit: null, scale: 1 }),
            6: Object.freeze({ label: "Altitude D Term", unit: null, scale: 1 }),
        ...
        DSHOT_RPM_TELEMETRY: Object.freeze({
            0: Object.freeze({ label: "Motor 1", unit: "eRPM", scale: 1 }),
            1: Object.freeze({ label: "Motor 2", unit: "eRPM", scale: 1 }),
            2: Object.freeze({ label: "Motor 3", unit: "eRPM", scale: 1 }),
            3: Object.freeze({ label: "Motor 4", unit: "eRPM", scale: 1 }),
            4: Object.freeze({ label: "Motor 5", unit: "eRPM", scale: 1 }),
            5: Object.freeze({ label: "Motor 6", unit: "eRPM", scale: 1 }),
            6: Object.freeze({ label: "Motor 7", unit: "eRPM", scale: 1 }),
            7: Object.freeze({ label: "Motor 8", unit: "eRPM", scale: 1 }),
        }),
        ...
        ESC_SENSOR_RPM: Object.freeze({
            ...
            4: Object.freeze({ label: "Motor 5 RPM", unit: "rpm", scale: 10 }),
            5: Object.freeze({ label: "Motor 6 RPM", unit: "rpm", scale: 10 }),
            6: Object.freeze({ label: "Motor 7 RPM", unit: "rpm", scale: 10 }),
            7: Object.freeze({ label: "Motor 8 RPM", unit: "rpm", scale: 10 }),
        }),
        ESC_SENSOR_TMP: Object.freeze({
            ...
            4: Object.freeze({ label: "Motor 5 Temperature", unit: "degC", scale: 1 }),
            5: Object.freeze({ label: "Motor 6 Temperature", unit: "degC", scale: 1 }),
            6: Object.freeze({ label: "Motor 7 Temperature", unit: "degC", scale: 1 }),
            7: Object.freeze({ label: "Motor 8 Temperature", unit: "degC", scale: 1 }),
        }),
        ...
        FLASH_TEST_PRBS: Object.freeze({
            ...
            6: Object.freeze({ label: "Checked Pages", unit: null, scale: 1 }),
        ...
        GHST: Object.freeze({
            ...
            2: Object.freeze({ label: "Negated RSSI", unit: "dBm", scale: 1 }),
        ...
        GPS_CONNECTION: Object.freeze({
            ...
            2: Object.freeze({ label: "Baud Detect Progress, Else Nav Message Age", unit: null, scale: 1 }),
            3: Object.freeze({ label: "Baud Rate, Else Nav Message Age", unit: null, scale: 1 }),
        ...
        LIDAR_TF: Object.freeze({
            ...
            7: Object.freeze({ label: "Frame Parser State", unit: null, scale: 1 }),
        }),
        ...
        MAVLINK_TELEMETRY: Object.freeze({
            ...
            1: Object.freeze({ label: "TX Buffer Free", unit: "bytes", scale: 1 }),
            2: Object.freeze({ label: "Heartbeat TX Count", unit: null, scale: 1 }),
            ...
            6: Object.freeze({ label: "VFR HUD TX Count", unit: null, scale: 1 }),
            7: Object.freeze({ label: "System Status TX Count", unit: null, scale: 1 }),
        }),
        ...
        MAX7456_SPICLOCK: Object.freeze({
            0: Object.freeze({ label: "CPU Overclock Level", unit: null, scale: 1 }),
        ...
        MULTI_GYRO_DIFF: Object.freeze({
            0: Object.freeze({ label: "Gyro 1 Roll Minus Fused", unit: "dps", scale: 1 }),
            1: Object.freeze({ label: "Gyro 1 Pitch Minus Fused", unit: "dps", scale: 1 }),
            2: Object.freeze({ label: "Gyro 2 Roll Minus Fused", unit: "dps", scale: 1 }),
            3: Object.freeze({ label: "Gyro 2 Pitch Minus Fused", unit: "dps", scale: 1 }),
            4: Object.freeze({ label: "Gyro 3 Roll Minus Fused", unit: "dps", scale: 1 }),
            5: Object.freeze({ label: "Gyro 3 Pitch Minus Fused", unit: "dps", scale: 1 }),
            6: Object.freeze({ label: "Gyro 4 Roll Minus Fused", unit: "dps", scale: 1 }),
            7: Object.freeze({ label: "Gyro 4 Pitch Minus Fused", unit: "dps", scale: 1 }),
        }),
        MULTI_GYRO_RAW: Object.freeze({
            0: Object.freeze({ label: "Gyro 1 Raw Roll", unit: "gyroADC", scale: 1 }),
            1: Object.freeze({ label: "Gyro 1 Raw Pitch", unit: "gyroADC", scale: 1 }),
            2: Object.freeze({ label: "Gyro 2 Raw Roll", unit: "gyroADC", scale: 1 }),
            3: Object.freeze({ label: "Gyro 2 Raw Pitch", unit: "gyroADC", scale: 1 }),
            4: Object.freeze({ label: "Gyro 3 Raw Roll", unit: "gyroADC", scale: 1 }),
            5: Object.freeze({ label: "Gyro 3 Raw Pitch", unit: "gyroADC", scale: 1 }),
            6: Object.freeze({ label: "Gyro 4 Raw Roll", unit: "gyroADC", scale: 1 }),
            7: Object.freeze({ label: "Gyro 4 Raw Pitch", unit: "gyroADC", scale: 1 }),
        }),
        MULTI_GYRO_SCALED: Object.freeze({
            0: Object.freeze({ label: "Gyro 1 Roll", unit: "dps", scale: 1 }),
            1: Object.freeze({ label: "Gyro 1 Pitch", unit: "dps", scale: 1 }),
            2: Object.freeze({ label: "Gyro 2 Roll", unit: "dps", scale: 1 }),
            3: Object.freeze({ label: "Gyro 2 Pitch", unit: "dps", scale: 1 }),
            4: Object.freeze({ label: "Gyro 3 Roll", unit: "dps", scale: 1 }),
            5: Object.freeze({ label: "Gyro 3 Pitch", unit: "dps", scale: 1 }),
            6: Object.freeze({ label: "Gyro 4 Roll", unit: "dps", scale: 1 }),
            7: Object.freeze({ label: "Gyro 4 Pitch", unit: "dps", scale: 1 }),
        }),
        ...
        PITOT: Object.freeze({
            ...
            2: Object.freeze({ label: "Raw Differential Pressure", unit: "Pa", scale: 1 }),
        ...
        RTH: Object.freeze({
            ...
            2: Object.freeze({ label: "Rescue Phase", unit: null, scale: 1 }),
            3: Object.freeze({ label: "Rescue Failure Code", unit: null, scale: 1 }),
        ...
        SMARTAUDIO: Object.freeze({
            ...
            3: Object.freeze({ label: "Power Level", unit: null, scale: 1 }),
        }),
        SPA: Object.freeze({
        ...
        VTX_TRAMP: Object.freeze({
            ...
            2: Object.freeze({ label: "Pit Mode And Config Flags", unit: null, scale: 1 }),
