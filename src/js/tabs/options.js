...
options.initShowWarnings = function () {
    ...
    $("div.presetsWarningBackup input")
        .change(function () {
...
options.initShowAllSerialDevices = function () {
    ...
    showAllSerialDevicesElement.prop("checked", !!result.showAllSerialDevices).on("change", () => {
...
options.initShowVirtualMode = function () {
    ...
    showVirtualModeElement.prop("checked", !!result.showVirtualMode).on("change", () => {
...
options.initUseManualConnection = function () {
    ...
    showManualModeElement.prop("checked", !!result.showManualMode).on("change", () => {
...
options.initShowDevToolsOnStartup = function () {
    ...
    $("div.showDevToolsOnStartup input")
        ...
        .change(function () {
            setConfig({ showDevToolsOnStartup: $(this).is(":checked") });
        })
        .change();
};
