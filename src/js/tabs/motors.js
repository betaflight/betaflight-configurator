    ...
    function process_html() {
        ...
        function updateVisibility() {
            ...
            $("div.minthrottle").toggle(
                analogProtocolConfigured && compareVersions.lt(FC.CONFIG.apiVersion, API_VERSION_1_47),
            );
        ...
        function update_ui() {
            ...
            if (FC.MOTOR_CONFIG.use_dshot_telemetry && !hasTelemetryError && isAllMotorValueEqual) {
                const avgRpm = (
                        Math.round((sumRpm / motorValues.length) * AVG_RPM_ROUNDING) / AVG_RPM_ROUNDING
                    ).toFixed(0),
