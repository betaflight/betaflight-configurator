...
vtx.updateVtxDeviceStatus = function()
{
    ...
    function vtxDeviceStatusReady()
    {
        ...
        $("#vtx_device_ready_description").text((FC.VTX_CONFIG.vtx_device_ready) ? i18n.getMessage('vtxReadyTrue') : i18n.getMessage('vtxReadyFalse'));
        $("#vtx_device_ready_description").toggleClass("active", FC.VTX_CONFIG.vtx_device_ready !== 0);
    }
