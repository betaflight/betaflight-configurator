...
OSD.loadDisplayFields = function () {
    ...
    OSD.ALL_DISPLAY_FIELDS = {
        ...
        DMP_SLIDER: {
            name: "DMP_SLIDER",
            text: "osdTextElementDmpSlider",
            desc: "osdDescElementDmpSlider",
            defaultPosition: -1,
            draw_order: 162,
            positionable: true,
            preview: "DMP[||||  ]1.6|RD24",
        },
        TRK_SLIDER: {
            name: "TRK_SLIDER",
            text: "osdTextElementTrkSlider",
            desc: "osdDescElementTrkSlider",
            defaultPosition: -1,
            draw_order: 163,
            positionable: true,
            preview: "TRK[||||| ]1.8|RP48",
        },
        STK_SLIDER: {
            name: "STK_SLIDER",
            text: "osdTextElementStkSlider",
            desc: "osdDescElementStkSlider",
            defaultPosition: -1,
            draw_order: 164,
            positionable: true,
            preview: "STK[|||   ]1.1|RFF120",
        },
        DMX_SLIDER: {
            name: "DMX_SLIDER",
            text: "osdTextElementDmxSlider",
            desc: "osdDescElementDmxSlider",
            defaultPosition: -1,
            draw_order: 165,
            positionable: true,
            preview: "DMX[|||   ]1.5|RDX30",
        },
        DFT_SLIDER: {
            name: "DFT_SLIDER",
            text: "osdTextElementDftSlider",
            desc: "osdDescElementDftSlider",
            defaultPosition: -1,
            draw_order: 166,
            positionable: true,
            preview: "DFT[||    ]0.8|RI36",
        },
        PID_SLIDER: {
            name: "PID_SLIDER",
            text: "osdTextElementPidSlider",
            desc: "osdDescElementPidSlider",
            defaultPosition: -1,
            draw_order: 167,
            positionable: true,
            preview: "PID[|||   ]1.0|PID30",
        },
        PIT_SLIDER: {
            name: "PIT_SLIDER",
            text: "osdTextElementPitSlider",
            desc: "osdDescElementPitSlider",
            defaultPosition: -1,
            draw_order: 168,
            positionable: true,
            preview: "PIT[|||   ]0.9|PIT30",
        },
        MLT_SLIDER: {
            name: "MLT_SLIDER",
            text: "osdTextElementMltSlider",
            desc: "osdDescElementMltSlider",
            defaultPosition: -1,
            draw_order: 169,
            positionable: true,
            preview: "MLT[|||   ]1.2|MLT30",
        },
        GF_SLIDER: {
            name: "GF_SLIDER",
            text: "osdTextElementGfSlider",
            desc: "osdDescElementGfSlider",
            defaultPosition: -1,
            draw_order: 170,
            positionable: true,
            preview: "GF[||||| ]1.8|L1-150",
        },
        DF_SLIDER: {
            name: "DF_SLIDER",
            text: "osdTextElementDfSlider",
            desc: "osdDescElementDfSlider",
            defaultPosition: -1,
            draw_order: 171,
            positionable: true,
            preview: "DF[||||  ]1.1|L1-100",
        },
        PID_ROLL: {
            name: "PID_ROLL",
