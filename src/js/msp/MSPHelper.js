                ...
                case MSPCodes.MSP_ADJUSTMENT_RANGES:
                    ...
                    for (let i = 0; i < adjustmentRangeCount; i++) {
                        const adjustmentRange = {
                            ...
                            adjustmentCenter: semver.gte(FC.CONFIG.apiVersion, API_VERSION_1_48) ? data.readU8() : 0,
                            adjustmentScale: semver.gte(FC.CONFIG.apiVersion, API_VERSION_1_48) ? data.readU8() : 0,
                        };
