                ...
                switch (code) {
                    ...
                    case MSPCodes.MSP_UID:
                        ...
                        FC.CONFIG.deviceIdentifier =
                            FC.CONFIG.uid[0].toString(16) +
                            FC.CONFIG.uid[1].toString(16) +
                            FC.CONFIG.uid[2].toString(16);
                        break;
                    ...
                    case MSPCodes.MSP_ADJUSTMENT_RANGES:
                        ...
                        for (let i = 0; i < adjustmentRangeCount; i++) {
                            const adjustmentRange = {
                                ...
                                adjustmentCenter: semver.gte(FC.CONFIG.apiVersion, API_VERSION_1_48)
                                    ? data.readU16()
                                    : 0,
                                adjustmentScale: semver.gte(FC.CONFIG.apiVersion, API_VERSION_1_48)
                                    ? data.readU16()
                                    : 0,
                            };
    ...
    crunch(code: number, modifierCode?: number): number[] {
        ...
        switch (code) {
            ...
            case MSPCodes.MSP_SET_FILTER_CONFIG:
                ...
                if (semver.gte(FC.CONFIG.apiVersion, API_VERSION_1_48)) {
                    buffer
                        .push16(FC.FILTER_CONFIG.gyro_rpm_notch_fade_range_hz)
                        .push16(FC.FILTER_CONFIG.gyro_rpm_notch_q);
                    for (let i = 0; i < 3; i++) {
