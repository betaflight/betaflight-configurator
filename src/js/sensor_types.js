...
import { removeArrayElement, addArrayElement } from "./utils/common";
...
export function sensorTypes() {
    ...
    if (semver.gte(FC.CONFIG.apiVersion, API_VERSION_1_47)) {
        ...
        addArrayElement(gyroElements, "IIM42653", "LSM6DSV16X");
        ...
        addArrayElement(accElements, "IIM42653", "LSM6DSV16X");

        addArrayElement(gpsElements, "VIRTUAL", "MSP");
    }
