...
// Configurator-side sanity margin for an implausible analog 3D neutral — not a firmware constant.
const NEUTRAL_3D_SANITY_MARGIN = 75;
...
export function computeZeroThrottleValue(is3dEnabled, isDigitalProtocol, motor3dNeutral, minSliderValue) {
    if (is3dEnabled) {
        ...
        const isImplausible = Math.abs(motor3dNeutral - PWM_RANGE_MIDDLE) > NEUTRAL_3D_SANITY_MARGIN;
