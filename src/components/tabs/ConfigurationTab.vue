                        ...
                        <div class="gui_box grey">
                            ...
                            <div class="spacer_box">
                                ...
                                <div class="select">
                                    ...
                                    <select
                                        class="gyroSyncDenom"
                                        v-model.number="pidAdvancedConfig.gyro_sync_denom"
                                        v-show="showGyroSyncDenom"
                                    >
                                        <!-- Options generated in logic -->
                                    </select>
            ...
            <div class="grid-row grid-box col2">
                ...
                <div class="col-span-1">
                    <div class="gui_box grey" v-if="accHardwareEnabled">
                        <div class="gui_box_titlebar">
                            <div class="spacer_box_title">{{ $t("configurationAccelerometerTrims") }}</div>
                            <div class="helpicon cf_tip" :title="$t('configurationAccelerometerTrimsHelp')"></div>
                        </div>
                        <div class="spacer_box">
                            <div class="number">
                                <label>
                                    <input type="number" name="acc_trim_roll" v-model.number="accelTrims.roll" />
                                    <span>{{ $t("configurationAccelerometerTrimsRoll") }}</span>
                                </label>
                            </div>
                            <div class="number">
                                <label>
                                    <input type="number" name="acc_trim_pitch" v-model.number="accelTrims.pitch" />
                                    <span>{{ $t("configurationAccelerometerTrimsPitch") }}</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gui_box grey">
                        ...
                        <div class="spacer_box">
                            ...
                            <div class="select" v-if="showGyro1Align">
                                ...
                                <span>{{ $t("configurationSensorGyroAlignment", { number: 1 }) }}</span>
                            </div>
                            ...
                            <div class="select" v-if="showGyro2Align">
                                ...
                                <span>{{ $t("configurationSensorGyroAlignment", { number: 2 }) }}</span>
                            </div>
                ...
                <div class="col-span-1">
                    ...
                    <div class="gui_box grey dshotbeeper">
                        <div class="gui_box_titlebar">
                            ...
                            <div class="helpicon cf_tip" :title="$t('configurationDshotBeeperHelp')"></div>
                        </div>
                        <div class="spacer_box">
                            <div class="select">
                                <select class="dshotBeeperBeaconTone" v-model.number="dshotBeaconTone">
                                    <option value="0">{{ $t("configurationDshotBeeperToneDisabled") }}</option>
                                    <option v-for="i in 5" :key="i" :value="i">{{ i }}</option>
                                </select>
                                <span>{{ $t("configurationDshotBeeperTone") }}</span>
                            </div>

                            <table class="dshot-beacon-table">
                                <thead>
                                    <tr>
                                        <th colspan="2">{{ $t("configurationDshotBeeperConditions") }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                    ...
                    <div class="gui_box grey beepers">
                        <div class="gui_box_titlebar">
                            ...
                            <div class="helpicon cf_tip" :title="$t('configurationBeeperHelp')"></div>
                        </div>
                        <div class="spacer_box">
...
export default defineComponent({
    ...
    setup() {
        ...
        const showGyroSyncDenom = ref(false);
        ...
        const initializeUI = () => {
            ...
            pidAdvancedConfig.gyro_sync_denom = FC.PID_ADVANCED_CONFIG.gyro_sync_denom;
